...
int pos = 81, i = 1, coins = 0, keys = 0, health = 100, atk = 0, def = 0, score = 0, deadzombies = 0, lvl = 0, completedlevels = 0, awards = 0, t = 81, dzc = 0, walls = 0, start[] = {81, 250}, firstrun = 1;
string zprev[400];
...
resetmap("Loading");
system("clear");
printf("Welcome to Super Key Seeker 4200(zombie survival mode) (build %s)\nYou are at the main menu, please select a difficulty:\n1. Easy\n2. Normal\n3. Hard\n4. Suicidal\n>", build);
int null = 1;
cin >> null;
if (null == 1)
{
