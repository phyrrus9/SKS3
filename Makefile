...
linux:
	mkdir -p ./Binaries
	c++ -g ./SKS3/main.cpp ./SKS3/engine/*.cpp ./SKS3/engine/windows/*.cpp  ./SKS3/ks4200/*.cpp ./SKS3/sks4200/sks4200.cpp ./SKS3/engine/streamlib/stream.a ./SKS3/engine/nwin/libnwin.a -lncurses -pthread -o ./Binaries/sks3	
install:
