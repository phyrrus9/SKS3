...
developer:
	...
	mkdir -p ./Binaries
	make linux
	gcc -o ./Binaries/mapmaker ./MAP/mapmaker.c -lncurses
linux:
	mkdir -p ./Binaries
	c++ $(FLAGS) ./SKS3/main.cpp ./SKS3/engine/*.cpp ./SKS3/engine/windows/*.cpp  ./SKS3/ks4200/*.cpp ./SKS3/sks4200/sks4200.cpp ./SKS3/engine/streamlib/stream.a ./SKS3/engine/nwin/libnwin.a -lncurses -pthread -o ./Binaries/sks3	
install:
	sudo cp ./Binaries/* /usr/bin
	sudo mkdir -p /usr/share/sks3
	sudo mkdir -p /usr/share/sks3/maps
	...
	sudo cp ./MAP/*.map /usr/share/sks3/maps/
